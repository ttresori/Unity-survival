...
public class PickAnItem : MonoBehaviour
{
    ...
    private void pick_item(GameObject player)
    {
        ...
        if (player_script_inventory.slot1 == null)
        {
            player_script_inventory.slot1 = gameObject.GetComponent<PrefabItem>().Prefabitem;
            pick_an_item.Slot1 = gameObject.GetComponent<PickAnItem>().sprite_item;
